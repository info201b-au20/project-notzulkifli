...
main_content <- mainPanel(
  ...
  p(
    "Three counties do not have any hospitals at all. They are Douglas, Skamania, and Wahkiakum."
  )
)
...
ui <- fluidPage(theme = shinytheme("superhero"),
  ...
  tabPanel("Introduction",
           mainPanel(
             h1("Introdution:"),
             p("Our dataset is used to recognize differing COVID-19 datasets across 
      ...
      impacted different people and cities.", align = 'center'),
             p("The data's we used were provided from the Department of Homeland
               Security (Foundation-Level Data), and the foundation of something
               something something something something"
               , align = 'right'),
             tags$img(src = "uwmedcenter.png", align = 'center'),
             p("UW Medical Center ||
               source: http://www.dailyuw.com/news/article_ec64c80c-b4f7-11ea-bed1-4ffbbfd1cb64.html"
               , align = 'center')
             ),
           ),
  tabPanel("Line Chart",
             ...
             sidebarLayout(
               sidebarPanel(
                 checkboxGroupInput("checkGroup", label = h3("Please Choose the Race/Races You Want to See the Data for"), 
                                    choices = list("White" = "Cases_White",
                                                   "Black" = "Cases_Black",
                                                   "LatinX" = "Cases_LatinX",
                                                   "Asian" = "Cases_Asian",
                                                   "AIAN" = "Cases_AIAN",
  ...
  tabPanel("Summary",
           ...
           tags$img(src = "mask.png", align = 'right')
    )
  )
)